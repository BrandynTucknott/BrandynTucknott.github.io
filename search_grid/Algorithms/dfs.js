class DFS
{
    ...
    {
        let stack = new Stack(); // stack of squares

        // stack the start square and mark as visited
        ...
        function drawDFS()
        {
            if (stack.size == 0) // end condition: nothing to deque
            {
            ...
            pushNeighbors(stack, x, y);
            interval = setTimeout(drawDFS, SPEED);
        }
